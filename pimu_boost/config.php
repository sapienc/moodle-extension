...
$THEME->renderers = [
    'course' => 'theme_pimu_boost_core_course_renderer'
];
// $THEME->rendererconfig = array(
//     'course' => array(
//         'class' => '\\theme_pimu_boost\\course\\core_course_renderer',
//     ),
// );
// $THEME->rendererclass = 'theme_pimu_boost_core_renderer';
// $THEME->rendererfile = 'renderers.php';
...
//     // The site home page.
//     'frontpage' => array(
//         'file' => 'pimu_frontpage.php', // 'drawers.php',
...
$THEME->scss = function($theme) {
    return theme_pimu_boost_get_main_scss_content($theme);
};

// ----- Debug Mode (also adds "Clear cache" possibility in the bottom of the page) -----
